logo='''
 ...
 |_| |_|_|\__, |_| |_|\___|_|     |_|\___/ \_/\_/ \___|_|      \_____|\__,_|_| |_| |_|\___|
           __/ |                                                                           
          |___/                                                                
...
def check_answer(guess,a_follower,b_follower):
    """Take the user guess and follower counts and returns if they got it right or not."""
...
while game_running:
    ...
    print(vs)
    print(f"With B: {format_data(account2)}")
