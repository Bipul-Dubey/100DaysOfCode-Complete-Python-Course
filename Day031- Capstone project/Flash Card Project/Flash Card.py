...
window=Tk()
window.title("Capstone Project- Flash Card")
...
card_title=canvas.create_text(400,80,text=" ",font=("Arial",40,"italic"))
card_word=canvas.create_text(400,200,text=" ",font=("Arial",60,"bold"))
